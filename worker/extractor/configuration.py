...
from packages.text import StopWords
from packages.text import StopWordsChinese
from packages.text import StopWordsArabic
from packages.text import StopWordsKorean
from .parsers import Parser, ParserSoup
from packages.urls import is_abs_url, get_domain
...
class Configuration(object):
    ...
    def __init__(self):
        ...
        """
        self.PROJECT_DIR = os.path.join(self.ABSPATH, "projects")
        ...
        # network info
        # self.browser_user_agent = 'crawlex/%s' % __version__
