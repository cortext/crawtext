...
POPULAR_URLS = os.path.join(PARENT_DIRECTORY, 'ressources/popular_sources.txt')
USERAGENTS = os.path.join(PARENT_DIRECTORY, 'ressources/useragents.txt')

STOPWORDS_DIR = os.path.join(PARENT_DIRECTORY, 'resources/text')

# NLP stopwords are != regular stopwords for now...
NLP_STOPWORDS_EN = os.path.join(PARENT_DIRECTORY, 'ressources/stopwords_en2.txt')
